...
void ExampleLayer::on_update(Lynton::TimeStep time_step)
{
	// update
...
void ExampleLayer::on_event(Lynton::Event& event)
{
...
bool ExampleLayer::on_key_pressed_event(Lynton::KeyPressedEvent event)
{
